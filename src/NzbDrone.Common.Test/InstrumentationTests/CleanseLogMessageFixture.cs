...
namespace NzbDrone.Common.Test.InstrumentationTests
{
    ...
    public class CleanseLogMessageFixture
    {
        ...
        [TestCase(@"https://rss.omgwtfnzbs.org/rss-search.php?catid=19,20&user=Bibliophilarr&api=mySecret&eng=1")]
        ...
        [TestCase("/bibliophilarr/signalr/messages/negotiate?access_token=1234530f422f4aacb6b301233210aaaa&negotiateVersion=1")]
        [TestCase(@"[Info] MigrationController: *** Migrating Database=bibliophilarr-main;Host=postgres14;Username=mySecret;Password=mySecret;Port=5432;Enlist=False ***")]
        [TestCase(@"[Info] MigrationController: *** Migrating Database=bibliophilarr-main;Host=postgres14;Username=mySecret;Password=mySecret;Port=5432;token=mySecret;Enlist=False&username=mySecret;mypassword=mySecret;mypass=shouldkeep1;test_token=mySecret;password=123%@%_@!#^#@;use_password=mySecret;get_token=shouldkeep2;usetoken=shouldkeep3;passwrd=mySecret;")]
        ...
        // Notifiarr
        [TestCase(@"https://xxx.yyy/api/v1/notification/bibliophilarr/9pr04sg6-0123-3210-imav-eql2tyu8xyui")]
        ...
        // OpenLibrary
        [TestCase(@"{""signatureMethod"": ""hmacSha1"",""signatureTreatment"": ""escaped"",""type"": ""protectedResource"",""method"": ""GET"",""token"": ""mytoken"",""tokenSecret"": ""mytokensecret"",""requestUrl"": ""https://openlibrary.org/review/list.xml"",""parameters"": {  ""_nc"": ""1"",  ""v"": ""2"",  ""id"": ""999999999"",  ""shelf"": ""currently-reading"",  ""per_page"": ""200"",  ""page"": ""1""}")]
        [TestCase(@"https://openlibrary.org/series/311911?key=1234530f422f4aacb6b301233210aaaa&_nc=1&format=xml")]
        public void should_clean_openlibrary_message(string message)
        {
            var cleansedMessage = CleanseLogMessage.Cleanse(message);
