...
{
    public class BibliophilarrImport : ImportListBase<BibliophilarrSettings>
    {
        private readonly IBibliophilarrV1Proxy _bibliophilarrV1Proxy;
        public override string Name => "Bibliophilarr";

        public override ImportListType ListType => ImportListType.Program;
        public override TimeSpan MinRefreshInterval => TimeSpan.FromMinutes(15);

        public BibliophilarrImport(IBibliophilarrV1Proxy bibliophilarrV1Proxy,
        ...
        {
            _bibliophilarrV1Proxy = bibliophilarrV1Proxy;
        }
        ...
        public override IList<ImportListItemInfo> Fetch()
        {
            ...
            try
            {
                var remoteBooks = _bibliophilarrV1Proxy.GetBooks(Settings);
                var remoteAuthors = _bibliophilarrV1Proxy.GetAuthors(Settings);
                ...
                foreach (var remoteBook in remoteBooks)
                {
                    ...
                    {
                        BookOpenLibraryId = remoteBook.ForeignBookId,
                        Book = remoteBook.Title,
                        EditionOpenLibraryId = remoteBook.ForeignEditionId,
                        Author = remoteAuthor.AuthorName,
                        AuthorOpenLibraryId = remoteAuthor.ForeignAuthorId
                    });
                }
        ...
        public override object RequestAction(string action, IDictionary<string, string> query)
        {
            ...
            {
                var devices = _bibliophilarrV1Proxy.GetProfiles(Settings);
            ...
            if (action == "getTags")
            {
                var devices = _bibliophilarrV1Proxy.GetTags(Settings);
            ...
            {
                var remoteRootFolders = _bibliophilarrV1Proxy.GetRootFolders(Settings);
        ...
        {
            failures.AddIfNotNull(_bibliophilarrV1Proxy.Test(Settings));
        }
    }
}
