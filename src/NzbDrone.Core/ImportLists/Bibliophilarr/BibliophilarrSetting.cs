...
{
    public class BibliophilarrSettingsValidator : AbstractValidator<BibliophilarrSettings>
    {
        public BibliophilarrSettingsValidator()
        {
    ...
    public class BibliophilarrSettings : IImportListSettings
    {
        private static readonly BibliophilarrSettingsValidator Validator = new BibliophilarrSettingsValidator();

        public BibliophilarrSettings()
        {
            BaseUrl = "";
            ApiKey = "";
        ...
        [FieldDefinition(0, Label = "Full URL", HelpText = "URL, including port, of the Bibliophilarr instance to import from")]
        public string BaseUrl { get; set; }

        [FieldDefinition(1, Label = "API Key", Privacy = PrivacyLevel.ApiKey, HelpText = "Apikey of the Bibliophilarr instance to import from")]
