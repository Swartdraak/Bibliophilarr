...
namespace NzbDrone.Core.Validation
{
    public static class RuleBuilderExtensions
    {
        ...
        public static IRuleBuilderOptions<T, string> ValidUrlBase<T>(this IRuleBuilder<T, string> ruleBuilder, string example = "/bibliophilarr")
        {
        ...
        public static IRuleBuilderOptions<T, string> ContainsBibliophilarr<T>(this IRuleBuilder<T, string> ruleBuilder)
        {
            ruleBuilder.SetValidator(new NotEmptyValidator(null));
            return ruleBuilder.SetValidator(new RegularExpressionValidator("bibliophilarr", RegexOptions.IgnoreCase)).WithMessage("Must contain bibliophilarr");
        }
    }
}
