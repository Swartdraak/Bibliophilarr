...
namespace NzbDrone.Core.Notifications.Join
{
    ...
    public class JoinProxy : IJoinProxy
    {
        ...
        public ValidationFailure Test(JoinSettings settings)
        {
            ...
            const string body = "This is a test message from Bibliophilarr.";
        ...
        private void SendNotification(string title, string message, HttpMethod method, JoinSettings settings)
        {
            ...
            var request = requestBuilder.AddQueryParam("apikey", settings.ApiKey)
                          ...
                          .AddQueryParam("icon", "https://cdn.rawgit.com/Bibliophilarr/Bibliophilarr/develop/Logo/256.png") // Use the Bibliophilarr logo.
                          .AddQueryParam("smallicon", "https://cdn.rawgit.com/Bibliophilarr/Bibliophilarr/develop/Logo/96-Outline-White.png") // 96x96px with outline at 88x88px on a transparent background.
