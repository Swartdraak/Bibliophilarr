...
namespace NzbDrone.Core.Notifications.Subsonic
{
    public class Subsonic : NotificationBase<SubsonicSettings>
    {
        ...
        {
            const string header = "Bibliophilarr - Grabbed";
        ...
        {
            const string header = "Bibliophilarr - Downloaded";
        ...
        {
            const string header = "Bibliophilarr - Author Deleted";
        ...
        {
            const string header = "Bibliophilarr - Book Deleted";
        ...
        {
            const string header = "Bibliophilarr - Book File Deleted";
