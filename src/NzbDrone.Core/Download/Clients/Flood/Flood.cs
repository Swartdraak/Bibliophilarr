...
namespace NzbDrone.Core.Download.Clients.Flood
{
    ...
    public class Flood : TorrentClientBase<FloodSettings>
    {
        ...
        public override ProviderMessage Message => new ProviderMessage("Bibliophilarr will handle automatic removal of torrents based on the current seed criteria in Settings -> Indexers", ProviderMessageType.Info);
