    ...
    public class DbFactory : IDbFactory
    {
        ...
        private void CreateMain(string connectionString, MigrationContext migrationContext, DatabaseType databaseType)
        {
            ...
            catch (SQLiteException e)
            {
                ...
                if (OsInfo.IsOsx)
                {
                    throw new CorruptDatabaseException("Database file: {0} is corrupt, restore from backup if available. See: https://github.com/Swartdraak/Bibliophilarr/wiki/faq#i-use-readarr-on-a-mac-and-it-suddenly-stopped-working-what-happened", e, fileName);
                }
