...
namespace NzbDrone.Common
{
    ...
    public class ConsoleService : IConsoleService
    {
        ...
        public void PrintHelp()
        {
            ...
            Console.WriteLine("                 /{0} Don't open {1} in a browser", StartupContext.NO_BROWSER, BuildInfo.AppName);
            Console.WriteLine("                 /{0} Start {1} terminating any other instances", StartupContext.TERMINATE, BuildInfo.AppName);
