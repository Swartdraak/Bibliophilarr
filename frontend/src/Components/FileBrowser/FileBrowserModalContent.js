        ...
        >
          {
            isWindowsService &&
              <Alert
                ...
                kind={kinds.WARNING}
              >
                Mapped network drives are not available when running as a Windows Service, see the <Link className={styles.faqLink} to="https://github.com/Swartdraak/Bibliophilarr/wiki/faq">FAQ</Link> for more information.
              </Alert>
          }
