...
module.exports = {
  ...
  // Log levels
  logInfoColor: '#1e90ff',
  logDebugColor: '#808080',
  logTraceColor: '#d3d3d3',

  // Star rating
  starBackColor: '#515253',
  ...
  // Status page
  statusLogoBorderColor: '#e6e6e6',
  statusLogoBackgroundColor: '#f8f8ff',

  // Author poster
  authorProgressBackgroundColor: '#5b5b5b'
};
