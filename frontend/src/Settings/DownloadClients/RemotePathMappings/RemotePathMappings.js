      ...
      <FieldSet legend={translate('RemotePathMappings')}>
        ...
        >
          ...
          <Alert kind={kinds.INFO}>
            <InlineMarkdown data={translate('RemotePathMappingsInfo', { app: 'Readarr', wikiLink: 'https://github.com/Swartdraak/Bibliophilarr/wiki/settings#remote-path-mappings' })} />
          </Alert>
