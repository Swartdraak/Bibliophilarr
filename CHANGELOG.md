...
- Consolidated project documentation into the canonical root files and focused
  `docs/operations` runbooks.
- Archived superseded wiki pages into `docs/archive` with deprecation banners.
- Repaired stale setup, release, and PR-template guidance to match current
  repository workflows and files.
- Archived superseded dated operational reports under `docs/archive/operations`
