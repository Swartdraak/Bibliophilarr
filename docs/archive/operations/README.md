...
This directory contains superseded operations documents retained for historical
context. Canonical active guidance lives in root canonical docs and active
operations runbooks.

## Archived documents

- [IMPLEMENTATION_STATUS_2026-03-15.md](IMPLEMENTATION_STATUS_2026-03-15.md)
- [conflict-strategy-staged-rollout-checklist-2026-03-16.md](conflict-strategy-staged-rollout-checklist-2026-03-16.md)
- [core-identification-fallback-hardening-2026-03-15.md](core-identification-fallback-hardening-2026-03-15.md)
- [dependabot-alert-remediation-2026-03-16.md](dependabot-alert-remediation-2026-03-16.md)
