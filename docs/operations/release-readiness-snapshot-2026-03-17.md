...
- Release decisions should use this snapshot together with the current [docs/operations/RELEASE_AUTOMATION.md](docs/operations/RELEASE_AUTOMATION.md) entry criteria.
